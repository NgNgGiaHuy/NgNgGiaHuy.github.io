...
export const HeroSection: React.FC = () => {
  return (
    <section className="h-screen flex flex-col relative overflow-x-clip px-6 md:px-10">
      ...
      {/* Navbar */}
      <FadeIn delay={0} y={-20} as="nav" className="flex justify-between items-center pt-6 md:pt-8 z-20 gap-2 sm:gap-4">
      ...
      <div className="flex justify-between items-end pb-7 sm:pb-8 md:pb-10 z-20">
        <FadeIn delay={0.35} y={20}>
          <p className="text-[#D7E2EA] font-light uppercase tracking-wide leading-snug max-w-[130px] sm:max-w-[220px] md:max-w-[260px]" style={{ fontSize: 'clamp(0.65rem, 1.4vw, 1.5rem)' }}>
      ...
      {/* Hero Portrait */}
      <FadeIn delay={0.6} y={30} className="absolute left-1/2 -translate-x-1/2 z-10 bottom-0 pointer-events-auto">
        <Magnet padding={150} strength={3}>
          <img 
            src="https://shrug-person-78902957.figma.site/_components/v2/d24c01ad3a56fc65e942a1f501eb73db42d7cf9a/Rectangle_40443.81459862.png" 
            alt="Jack 3D Portrait"
            className="w-[180px] sm:w-[360px] md:w-[440px] lg:w-[520px] object-contain"
          />
        </Magnet>
      </FadeIn>
